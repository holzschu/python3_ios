...
if COMPILE_LIBFFI:
    ...
    # iOS: can't call all this.
    print("iOS: not trying to compile")
    # use_pkg_config()
    # ask_supports_thread()
...
if 'darwin' in sys.platform:
    # iOS: can't run xcrun
    include_dirs.append('~/Documents/include')
    include_dirs.append('~/Library/include')
    # try:
...
if __name__ == '__main__':
    ...
    cpython = True # ('_cffi_backend' not in sys.builtin_module_names)
...
""",
        ...
        )] if ('_cffi_backend' not in sys.builtin_module_names) else [],
        # )] if cpython else [],
