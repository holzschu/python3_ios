...
// Outside iOS: this file is linked into several different dynamic libraries.
// Inside iOS: this file is *included* into the different source files, all of them linked together.
...
static int
#endif
    convert_from_method(PyObject *obj, const char *name, converter func, void *p)
{
    PyObject *value;
    ...
    static int
#endif
 convert_from_attr(PyObject *obj, const char *name, converter func, void *p)
{
    PyObject *value;
    ...
    static int
#endif
 convert_voidptr(PyObject *obj, void *p)
{
    void **val = (void **)p;
    *val = PyLong_AsVoidPtr(obj);
    ...
    static int
#endif
 convert_double(PyObject *obj, void *p)
{
    double *val = (double *)p;
    ...
    *val = PyFloat_AsDouble(obj);
    ...
    static int
#endif
 convert_bool(PyObject *obj, void *p)
{
    bool *val = (bool *)p;
    int ret;
    ...
    *val = ret != 0;
    ...
    static int
#endif
 convert_cap(PyObject *capobj, void *capp)
{
    ...
    *(agg::line_cap_e *)capp = (agg::line_cap_e)result;
    ...
    static int
#endif
 convert_join(PyObject *joinobj, void *joinp)
{
    ...
    *(agg::line_join_e *)joinp = (agg::line_join_e)result;
    ...
    static int
#endif
 convert_rect(PyObject *rectobj, void *rectp)
{
    ...
    static int
#endif
 convert_rgba(PyObject *rgbaobj, void *rgbap)
{
    ...
    static int
#endif
 convert_dashes(PyObject *dashobj, void *dashesp)
{
    ...
    static int
#endif
 convert_dashes_vector(PyObject *obj, void *dashesp)
{
    ...
    static int
#endif
 convert_trans_affine(PyObject *obj, void *transp)
{
    ...
    static int
#endif
 convert_path(PyObject *obj, void *pathp)
{
...
exit:
    ...
    static int
#endif
 convert_clippath(PyObject *clippath_tuple, void *clippathp)
{
    ...
    static int
#endif
 convert_snap(PyObject *obj, void *snapp)
{
    ...
    static int
#endif
 convert_sketch_params(PyObject *obj, void *sketchp)
{
    ...
    static int
#endif
 convert_gcagg(PyObject *pygc, void *gcp)
{
    GCAgg *gc = (GCAgg *)gcp;
    ...
    static int
#endif
 convert_offset_position(PyObject *obj, void *offsetp)
{
    ...
    *offset = (e_offset_position)result;
    ...
    static int
#endif
 convert_face(PyObject *color, GCAgg &gc, agg::rgba *rgba)
{
    ...
    static int
#endif
 convert_points(PyObject *obj, void *pointsp)
{
    ...
    static int
#endif
 convert_transforms(PyObject *obj, void *transp)
{
    ...
    static int
#endif
 convert_bboxes(PyObject *obj, void *bboxp)
{
    ...
    static int
#endif
 convert_colors(PyObject *obj, void *colorsp)
{
