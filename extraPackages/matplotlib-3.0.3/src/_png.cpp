...
// iOS: need non static member functions. This replaces buffer.converter_contiguous:
static int (*buffer_converter_contiguous)(PyObject *obj, void *arrp) = numpy::numpy_converter_contiguous<unsigned char, 3>;
...
static PyObject *Py_write_png(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args,
                                     ...
                                     "O&O|diiO:write_png",
                                     (char **)names,
                                     // iOS: need non static member functions
                                     buffer_converter_contiguous,
