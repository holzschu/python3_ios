 ...
 *         if ctrl_mask == 0:
 */
    __pyx_t_5 = __Pyx_PyInt_AddObjC(__pyx_v_ii, __pyx_int_1, 1, 1, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 132, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
...
static void PyTypes_ResetAll(void) {
	PyType_Reset(&__pyx_type_6pandas_2io_3sas_4_sas_Parser);
	...
	__pyx_type_6pandas_2io_3sas_4_sas_Parser.tp_flags = Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_VERSION_TAG|Py_TPFLAGS_CHECKTYPES|Py_TPFLAGS_HAVE_NEWBUFFER|Py_TPFLAGS_BASETYPE|Py_TPFLAGS_HAVE_GC; /*tp_flags*/
